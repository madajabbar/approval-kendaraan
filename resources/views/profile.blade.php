...
@section('content')
    ...
    <div class="card card-body blur shadow-blur mx-4 mt-n6 overflow-hidden">
        <div class="row gx-4">
            ...
            <div class="col-auto my-auto">
                <div class="h-100">
                    <h5 class="mb-1">
                        {{ Auth::user()->name ? Auth::user()->name : 'sign in' }}
                    </h5>
                    <p class="mb-0 font-weight-bold text-sm">
                        {{ Auth::user()->email ? Auth::user()->email : 'sign in' }}
                    </p>
                </div>
            </div>
    ...
    @if (Auth::user()->role->level != 'admin')
        <div class="card card-body blur shadow-blur mx-4 mt-3 overflow-hidden">
            <div class="row">
                <div class="col">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route('user.store')}}" method="post">
                                                @csrf
                                                <input type="text" hidden name="approval_id" value="{{$value->id}}">
